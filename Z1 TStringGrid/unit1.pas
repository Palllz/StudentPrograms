...
type
  ...
  TForm1 = class(TForm)     //Класс формы
    ...
    procedure MSaveOtClick(Sender: TObject);
    procedure MZagClick(Sender: TObject);
    //Методы класса
  private
...
Const INF ='Автор:Абловацкий Юрий'+#13#10+'Задача №8'+#13#10+'Определить периметр правильного n-угольника, описанного около окружности радиуса r.';
var
